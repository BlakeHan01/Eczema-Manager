...
// const url = process.env.NODE_ENV === 'PRODUCTION' ? 'https://eczema-forums.herokuapp.com/diarys' : 'http://localhost:5000/diarys'
const url = 'https://eczema-forums.herokuapp.com/diarys';
...
const url2 = 'https://eczema-forums.herokuapp.com/users';
// const url2 = process.env.NODE_ENV === 'PRODUCTION' ? 'https://eczema-forums.herokuapp.com/users' : 'http://localhost:5000/users'
